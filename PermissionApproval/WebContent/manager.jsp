	...
	System.out.println("Connection Established");
 	...
 	<a href="reg.html">Try Again</a> 
 	 ...
 	 { 
 	 	 ...
 	 	 pstmt.setInt(1, id);  	 	 pstmt.setString(2, uname);  	 	 pstmt.setString(3, pwd);  	 	 pstmt.setString(4, email);  	 	 pstmt.setString(6, gender);  	 	 pstmt.setString(7, mobile);  	 	 pstmt.setString(5, fname); 
